...
import { A as renderTemplate, V as createAstro, j as maybeRenderHead, w as renderComponent } from "./sequence_rQseZV6z.mjs";
import { t as createComponent } from "./compiler_CHD7gGAf.mjs";
import { t as $$Layout } from "./Layout_BOI9Rcs_.mjs";
import { o as byCategory } from "./cache_C5L6PGMb.mjs";
...
import { r as categoryAlternate } from "./alternates_D4gIk_oP.mjs";
...
var $$Cat = createComponent(async ($$result, $$props, $$slots) => {
	...
	}, { "default": ($$result) => renderTemplate`${maybeRenderHead($$result)}<main id="main"><header class="jnl-band jnl-tone-navy"><div class="tds-shell"><a href="/" class="btn-back"><span aria-hidden="true">←</span> Alle Beiträge</a><p class="section-num mb-4 mt-6">Journal · Kategorie</p><h1 class="display page-title"><span class="accent-italic">${name}</span></h1><p class="marginalia mt-3">${posts.length === 1 ? "Ein Artikel in dieser Kategorie." : `${posts.length} Artikel in dieser Kategorie.`}</p></div></header><section class="jnl-band jnl-tone-tint"><div class="tds-shell"><ul class="jnl-stack">${posts.map((p) => renderTemplate`${renderComponent($$result, "BlogPostCard", $$BlogPostCard, {
		"slug": p.slug,
		"category": p.category,
		"title": p.title,
		"excerpt": p.excerpt,
