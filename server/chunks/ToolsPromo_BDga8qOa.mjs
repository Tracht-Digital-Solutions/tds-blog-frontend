...
import { a as PostCover, n as TOOLS_URL, s as transitionUpdate } from "./Layout_BOI9Rcs_.mjs";
import { i as formatPostDate, n as PostCard, r as fallbackAuthorName, t as AuthorChip } from "./PostCard_nFlNAXZZ.mjs";
...
function CategorySidebar({ posts, cats, value, onChange, collapsed, onToggle, t }) {
	...
	return /* @__PURE__ */ jsxs("nav", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			className: "jnl-stack",
			children: ["all", ...cats].map((c) => /* @__PURE__ */ jsxs("button", {
				type: "button",
...
function BlogIndex({ posts, popular = [], lang, pageSize = 10 }) {
	...
	const pickCat = (next) => transitionUpdate(() => flushSync(() => setCat(next)));
	...
	if (posts.length === 0) return /* @__PURE__ */ jsx("div", {
		className: "jnl-band jnl-tone-tint",
		children: /* @__PURE__ */ jsx("p", {
			className: "tds-shell text-[var(--color-muted)] italic",
			children: t.empty
		})
	});
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [!searching && featured && /* @__PURE__ */ jsx(HeroSlider, {
			...
			className: "jnl-band jnl-tone-tint",
			children: /* @__PURE__ */ jsxs("div", {
				className: "tds-shell lg:flex lg:items-start lg:gap-px",
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: [
						/* @__PURE__ */ jsx("div", {
							className: "lg:hidden pb-6 overflow-x-auto blog-cat-strip",
							children: /* @__PURE__ */ jsx("div", {
...
function ForYou({ lang, limit = 3 }) {
	...
	return /* @__PURE__ */ jsx("aside", {
		className: "jnl-band jnl-tone-sand",
		"aria-labelledby": "for-you-heading",
		children: /* @__PURE__ */ jsxs("div", {
			className: "tds-shell",
			children: [/* @__PURE__ */ jsxs("div", {
				className: "flex flex-wrap items-baseline justify-between gap-3 pb-8",
				...
				className: "tds-grid-auto tds-grid-roomy jnl-mosaic",
				children: picks.map((p) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("a", {
					href: `/${p.slug}`,
					className: "jnl-tile block group h-full p-5",
					children: [
						/* @__PURE__ */ jsx("p", {
...
var $$ToolsPromo = createComponent(($$result, $$props, $$slots) => {
	...
	return renderTemplate`${maybeRenderHead($$result)}<aside class="tools-promo jnl-band jnl-tone-accent" aria-labelledby="tools-promo-heading"><div class="tds-shell"><p class="tools-promo__eyebrow">${copy.eyebrow}</p><h2 id="tools-promo-heading" class="tools-promo__heading">${copy.heading}</h2><p class="tools-promo__body">${copy.body}</p><p class="tools-promo__lead">${copy.lead}</p><ul class="tools-promo__list">${[
		{
	...
	].map((p) => renderTemplate`<li><a${addAttribute(`${base}/tools/${p.slug}`, "href")} class="tools-promo__link">${lang === "de" ? p.de : p.en}</a></li>`)}</ul><p class="tools-promo__all"><a${addAttribute(base, "href")} class="tools-promo__link">${copy.all}</a></p></div></aside>`;
