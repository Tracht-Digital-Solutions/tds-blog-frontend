...
import { A as renderTemplate, N as addAttribute, V as createAstro, _t as isRemotePath, c as createConsoleLogger, gt as isParentDirectory, j as maybeRenderHead, vt as joinPaths, x as spreadAttributes, xt as removeQueryString, z as unescapeHTML } from "./sequence_rQseZV6z.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_BRrbeBp-.mjs").catch((e) => {
